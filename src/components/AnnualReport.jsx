...
export default function AnnualReport({ state }) {
  ...
  return (
    <div className="animate-pop-up" style={{ display: 'flex', flexDirection: 'column', gap: '28px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="no-print" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '2rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <FileBarChart2 size={28} color="#a855f7" /> Annual Life Growth Report
          </h2>
      ...
      <div id="annual-report-print-area" className="glass-panel" style={{ padding: '40px', background: '#080c18', border: '1px solid rgba(168, 85, 247, 0.25)', display: 'flex', flexDirection: 'column', gap: '32px', boxShadow: '0 8px 32px 0 rgba(168, 85, 247, 0.05)' }}>
        
        {/* Branding header */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid rgba(168, 85, 247, 0.3)', paddingBottom: '20px' }}>
          <div>
            <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: '2rem', letterSpacing: '-0.025em' }}>
              Atharv<span style={{ color: '#a855f7' }}>OS</span> Annual Performance Report
            </h1>
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <div style={{ fontSize: '2rem', fontWeight: 900, color: '#a855f7', fontFamily: 'var(--font-display)', lineHeight: '1' }}>{state.profile.level}</div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
          ...
          <div style={{ padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', textAlign: 'center' }}>
            ...
            <strong style={{ fontSize: '1.5rem', color: '#fff', fontFamily: 'var(--font-display)' }}>{state.academicMetrics.cgpa.toFixed(2)}</strong>
          </div>
          ...
          <div style={{ padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', textAlign: 'center' }}>
            ...
            <strong style={{ fontSize: '1.5rem', color: '#fff', fontFamily: 'var(--font-display)' }}>{state.dsaMetrics.solvedCount}</strong>
          </div>
          ...
          <div style={{ padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', textAlign: 'center' }}>
            ...
            <strong style={{ fontSize: '1.5rem', color: '#fff', fontFamily: 'var(--font-display)' }}>{state.aimlMetrics.papersReadCount}</strong>
          </div>
          ...
          <div style={{ padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', textAlign: 'center' }}>
            ...
            <strong style={{ fontSize: '1.5rem', color: '#fff', fontFamily: 'var(--font-display)' }}>{state.careerMetrics.resumeScore}%</strong>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '24px' }}>
          ...
          <div>
            <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '1.15rem', color: '#a855f7', display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '8px' }}>
        ...
        {/* Sign-off area */}
        <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '24px', fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>
